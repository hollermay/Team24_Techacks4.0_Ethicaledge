        ...
        <div style={{height:'100vh'}} className={`border-l border-r border-gray-300 ${localStorage.getItem('theme')==0?"dark:bg-slate-800 dark:text-white dark:text-slate-400":""} h-[90vh] flex flex-col relative`}>
            ...
            <div className="h-[12%] grid items-center bg-transparent ">
                <div className="relative flex justify-center items-center">
                    <input type="text" ref={chatInput} onChange={(e) => { setMessage(e.target.value) }} placeholder="Ask LegalSage to get your Legal Queries Answered........" onKeyDown={handleEnterKey} className={`w-[70%] ml-auto mr-auto p-5 pr-14 h-[50px] leading-3 ${localStorage.getItem('theme')=='0'?"bg-[#0000007d]":"bg-gray-300"} 
                    border-0 rounded-full focus:outline-none`}/>
